...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { request: @query.request, response: @query.response, title: @query.title } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { request: @query.request, response: @query.response, title: @query.title } }
